...
function _clearCanvas(){ const canvas = document.querySelector('canvas'); const context = canvas.getContext('2d'); context.clearRect(0, 0, canvas.width, canvas.height); }
function _drawSquare(x,y,w,h){ const canvas = document.querySelector('canvas'); const context = canvas.getContext('2d'); context.fillStyle = '#a5a5a5'; context.beginPath(); context.fillRect(x, y, w, h); context.fill(); }
function _dump(data){ console.log(data); }



// STATICTOP = STATIC_BASE + 8096;
...
var real____em_js__clearCanvas = asm["___em_js__clearCanvas"]; asm["___em_js__clearCanvas"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__clearCanvas.apply(null, arguments);
};

var real____em_js__drawSquare = asm["___em_js__drawSquare"]; asm["___em_js__drawSquare"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__drawSquare.apply(null, arguments);
};

var real____em_js__dump = asm["___em_js__dump"]; asm["___em_js__dump"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__dump.apply(null, arguments);
};
...
var ___em_js__clearCanvas = Module["___em_js__clearCanvas"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__clearCanvas"].apply(null, arguments) };
var ___em_js__drawSquare = Module["___em_js__drawSquare"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__drawSquare"].apply(null, arguments) };
var ___em_js__dump = Module["___em_js__dump"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__dump"].apply(null, arguments) };
